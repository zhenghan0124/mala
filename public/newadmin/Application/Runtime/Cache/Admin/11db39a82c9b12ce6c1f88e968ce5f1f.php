...
<div class="padding">
  ...
  <a href="<?php echo U('Meitu/index',array('shenhe' => 1));?>" class="btn btn-fw primary m-b" style="margin-left:10px;background:red">待审核</a><br/>
  <a href="<?php echo U('Meitu/index');?>" class="btn btn-fw primary m-b" style="margin-left:10px;">全部</a>
  <div class="row">
    <div class="col-sm-12">
      <div class="box">
        <table class="table table-striped b-t">
          ...
          <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>
              ...
              <td><textarea><?php echo ($data["txt"]); ?></textarea></td>
              <td><img src="<?php echo ($data["tutieurl"]); ?>" width="80"></td>
              <td><?php echo ($data["name"]); ?></td>
              <td><img src="<?php echo ($data["photo"]); ?>" width="80"></td>
              <?php if(($data["shenhe"]) == "2"): ?><td><a href="#" id="audit<?php echo ($data['id']); ?>" onclick="audit(<?php echo ($data['id']); ?>,1)" style="color:green">已审核</a></td><?php else: ?><td><a href="#" id="audit<?php echo ($data['id']); ?>" onclick="audit(<?php echo ($data['id']); ?>,2)" style="color:red">待审核</a></td><?php endif; ?>
