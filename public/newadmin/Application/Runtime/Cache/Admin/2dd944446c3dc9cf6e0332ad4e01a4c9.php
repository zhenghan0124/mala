...
<div class="padding">
  ...
  <a href="<?php echo U('Template/add_template');?>" class="btn btn-fw primary m-b" style="margin-left:10px;">添加</a>
  <div class="row">
    <div class="col-sm-12">
      <div class="box">
        <table class="table table-striped b-t">
          ...
          <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>
              ...
              <td><?php echo ($data["img_height"]); ?></td>
              <td><?php echo ($data["text_x"]); ?></td>
              <td><?php echo ($data["text_y"]); ?></td>
              <td><?php echo ($data["text_width"]); ?></td>

              <td><?php echo ($data["hang_height"]); ?></td>
              <td><?php echo ($data["font_size"]); ?></td>

              <td><?php echo ($data["type"]); ?></td>

              <td><?php echo ($data["qcode_x"]); ?></td>
              <td><?php echo ($data["qcode_y"]); ?></td>
              <td><?php echo ($data["qcode_width"]); ?></td>
              <td><?php echo ($data["qcode_height"]); ?></td>
              <td><?php echo ($data["userimg_x"]); ?></td>
              <td><?php echo ($data["userimg_y"]); ?></td>
              <td><?php echo ($data["userimg_width"]); ?></td>
              <td><?php echo ($data["userimg_height"]); ?></td>
              <td><?php echo ($data["username_x"]); ?></td>
              <td><?php echo ($data["username_y"]); ?></td>
              <td><?php echo ($data["username_size"]); ?></td>
              <td><?php echo ($data["date_x"]); ?></td>
              <td><?php echo ($data["date_y"]); ?></td>
              <td><?php echo ($data["date_size"]); ?></td>

              <td><a href="<?php echo U('edit_template',array('id' => $data['id']));?>">查看</a> <a href="<?php echo U('del_template',array('id'=>$data['id']));?>" class="text-danger" onclick="return confirm('确认要删除吗，删除后无法恢复？')">删除</a></td>
