        ...
        <div class="box-body">
          <form role="form" class="validate" action="" method="post">
                  ...
                  <div class="qy-upload upload-pic">
                    <ul>
                      <?php if(!empty($data["imgurl"])): if(is_array($data["imgurl"])): $i = 0; $__LIST__ = $data["imgurl"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
                          <img src="/newadmin/Uploads/<?php echo ($vo); ?>">
                          <input type="hidden" name="pic[]" value="<?php echo ($vo); ?>">
                          <span class="qy-upload-del"><i class="fa fa-remove"></i></span>
                        </li><?php endforeach; endif; else: echo "" ;endif; endif; ?>
                      <li class="upload-pic-wrap" <?php if(!empty($data["imgurl"])): ?>style="display:none;"<?php endif; ?>>
            ...
            <div class="form-group">
              ...
              <div class="row">
                <div class="col-md-6">
                  <input type="text" name="typeid" class="form-control" value="<?php echo ($data["typeid"]); ?>">
                </div>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="row">
                <div class="col-md-6">
                  <input type="text" name="collection" class="form-control" value="0">
                </div>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="row">
                <div class="col-md-6">
                  <input type="text" name="download" class="form-control" value="0">
                </div>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="row">
                <div class="col-md-6">
                  <input type="text" name="share" class="form-control" value="0">
                </div>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="row">
                <div class="col-md-6">
                  <select name="tj" class="form-control">
                    <?php if(($data["recommended"]) == "1"): ?><option value="1">否</option><option value="2">是</option><?php endif; ?>
                    <?php if(($data["recommended"]) == "2"): ?><option value="2">是</option><option value="1">否</option><?php endif; ?>
                  </select>
                </div>
              </div>
            </div>
...
<!-- core -->
  ...
  <script type="text/javascript">
    $('.qy-upload').qy_upload("/newadmin/index.php/Admin/upload/?width=450&height=300","pic",1);
  </script>
