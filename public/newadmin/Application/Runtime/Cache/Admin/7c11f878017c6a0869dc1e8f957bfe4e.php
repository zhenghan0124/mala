      ...
      <div class="box">
        <table class="table table-striped b-t">
          ...
          <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>
              ...
              <?php if(($data["audit"]) == "1"): ?><td><a href="#" style="color:green">已审核</a></td><?php else: ?><td><a href="#" style="color:red">待审核</a></td><?php endif; ?>
              <?php if(($data["recommended"]) == "1"): ?><td><a href="#" style="color:red">未推荐</a></td><?php else: ?><td><a href="#" style="color:green">已推荐</a></td><?php endif; ?>
              ...
              <td><a href="<?php echo U('edit',array('id' => $data['id']));?>">查看</a></td>
