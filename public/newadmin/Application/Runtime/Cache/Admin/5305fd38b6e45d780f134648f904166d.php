...
<div class="padding">
  ...
  <a href="<?php echo U('Index/usercontent',array('audit' => 2));?>" class="btn btn-fw primary m-b" style="margin-left:10px;background:red">待审核</a><br/>
  <a href="<?php echo U('Index/usercontent');?>" class="btn btn-fw primary m-b" style="margin-left:10px;">全部</a>
  <?php if(is_array($types)): $i = 0; $__LIST__ = $types;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$type): $mod = ($i % 2 );++$i;?><a href="<?php echo U('Index/usercontent',array('typeid' => $type['id']));?>" class="btn btn-fw primary m-b" style="margin-left:10px;"><?php echo ($type["title"]); ?></a><?php endforeach; endif; else: echo "" ;endif; ?>
  <div class="row">
    <div class="col-sm-12">
      <div class="box">
        <table class="table table-striped b-t">
          ...
          <tr>
            ...
            <th>审核</th>
            <th>推荐</th>
            <th>点赞数|<a href="<?php echo U('Index/usercontent',array('sort' => 2));?>" style="color:grey">倒序</a>|<a href="<?php echo U('Index/usercontent',array('sort' => 1));?>" style="color:grey">顺序</a></th>
            <!--&lt;!&ndash;             <th>日期</th>-->
            <th>发布时间</th>
            <th>热度推荐</th>
            <th>操作</th>
          ...
          <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>
              ...
              <?php if(($data["audit"]) == "1"): ?><td><a href="<?php echo U('Index/useraudit',array('id' => $data['id'],'audit' => 2));?>" style="color:green">已审核</a></td><?php else: ?><td><a href="<?php echo U('Index/useraudit',array('id' => $data['id'],'audit' => 1));?>" style="color:red">待审核</a></td><?php endif; ?>
              <?php if(($data["recommended"]) == "1"): ?><td><a href="<?php echo U('Index/userrecommended',array('id' => $data['id'],'recommended' => 2));?>" style="color:red">未推荐</a></td><?php else: ?><td><a href="<?php echo U('Index/userrecommended',array('id' => $data['id'],'recommended' => 1));?>" style="color:green">已推荐</a></td><?php endif; ?>
              <td><?php echo ($data["support"]); ?></td>
              <td><?php echo ($data["time"]); ?></td>
              <?php if(($data["hot"]) == "1"): ?><td><a href="<?php echo U('Index/userhot',array('id' => $data['id'],'hot' => 0));?>" style="color:green">是</a></td><?php else: ?><td><a href="<?php echo U('Index/userhot',array('id' => $data['id'],'hot' => 1));?>" style="color:red">否</a></td><?php endif; ?>
              <!-- <td>
              ...
              <td><a href="<?php echo U('edit_usercontent',array('id' => $data['id']));?>">查看</a> <a href="<?php echo U('del',array('id'=>$data['id']));?>" class="text-danger" onclick="return confirm('确认要删除吗，删除后无法恢复？')">删除</a></td>
