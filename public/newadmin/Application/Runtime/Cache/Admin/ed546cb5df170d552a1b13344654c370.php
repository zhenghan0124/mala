        ...
        <div class="box-body">
          <form role="form" class="validate" action="" method="POST">
            ...
            <div class="form-group">
              ...
              <div class="row">
                <div class="col-md-6">
                  <input type="text" class="form-control" name="img_x" value="<?php echo ($data["img_x"]); ?>">
                </div>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="row">
                <div class="col-md-6">
                  <input type="text" class="form-control" name="img_y" value="<?php echo ($data["img_y"]); ?>">
                </div>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="row">
                <div class="col-md-6">
                  <input type="text" class="form-control" name="img_width" value="<?php echo ($data["img_width"]); ?>">
                </div>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="row">
                <div class="col-md-6">
                  <input type="text" class="form-control" name="img_height" value="<?php echo ($data["img_height"]); ?>">
                </div>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="row">
                <div class="col-md-6">
                  <input type="text" class="form-control" name="text_x" value="<?php echo ($data["text_x"]); ?>">
                </div>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="row">
                <div class="col-md-6">
                  <input type="text" class="form-control" name="text_y" value="<?php echo ($data["text_y"]); ?>">
                </div>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="row">
                <div class="col-md-6">
                  <input type="text" class="form-control" name="text_width" value="<?php echo ($data["text_width"]); ?>">
                </div>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="row">
                <div class="col-md-6">
                  <input type="text" class="form-control" name="muban_background" value="<?php echo ($data["muban_background"]); ?>">
                </div>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="row">
                <div class="col-md-6">
                  <input type="text" class="form-control" name="hang_height" value="<?php echo ($data["hang_height"]); ?>">
                </div>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="row">
                <div class="col-md-6">
                  <input type="text" class="form-control" name="font_size" value="<?php echo ($data["font_size"]); ?>">
                </div>
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="row">
                <div class="col-md-6">
                  <input type="text" class="form-control" name="qcode" value="<?php echo ($data["qcode"]); ?>">
                </div>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="row">
                <div class="col-md-6">
                  <input type="text" class="form-control" name="qcode_x" value="<?php echo ($data["qcode_x"]); ?>">
                </div>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="row">
                <div class="col-md-6">
                  <input type="text" class="form-control" name="qcode_y" value="<?php echo ($data["qcode_y"]); ?>">
                </div>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="row">
                <div class="col-md-6">
                  <input type="text" class="form-control" name="qcode_width" value="<?php echo ($data["qcode_width"]); ?>">
                </div>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="row">
                <div class="col-md-6">
                  <input type="text" class="form-control" name="qcode_height" value="<?php echo ($data["qcode_height"]); ?>">
                </div>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="row">
                <div class="col-md-6">
                  <input type="text" class="form-control" name="userimg_x" value="<?php echo ($data["userimg_x"]); ?>">
                </div>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="row">
                <div class="col-md-6">
                  <input type="text" class="form-control" name="userimg_y" value="<?php echo ($data["userimg_y"]); ?>">
                </div>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="row">
                <div class="col-md-6">
                  <input type="text" class="form-control" name="userimg_width" value="<?php echo ($data["userimg_width"]); ?>">
                </div>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="row">
                <div class="col-md-6">
                  <input type="text" class="form-control" name="userimg_height" value="<?php echo ($data["userimg_height"]); ?>">
                </div>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="row">
                <div class="col-md-6">
                  <input type="text" class="form-control" name="username_x" value="<?php echo ($data["username_x"]); ?>">
                </div>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="row">
                <div class="col-md-6">
                  <input type="text" class="form-control" name="username_y" value="<?php echo ($data["username_y"]); ?>">
                </div>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="row">
                <div class="col-md-6">
                  <input type="text" class="form-control" name="username_size" value="<?php echo ($data["username_size"]); ?>">
                </div>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="row">
                <div class="col-md-6">
                  <input type="text" class="form-control" name="date_x" value="<?php echo ($data["date_x"]); ?>">
                </div>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="row">
                <div class="col-md-6">
                  <input type="text" class="form-control" name="date_y" value="<?php echo ($data["date_y"]); ?>">
                </div>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="row">
                <div class="col-md-6">
                  <input type="text" class="form-control" name="date_size" value="<?php echo ($data["date_size"]); ?>">
                </div>
              </div>
            </div>
