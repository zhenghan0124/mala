  ...
  <div class="row">
    <div class="col-md-12">
      <div class="box">
        ...
        <div class="box-body">
          <form role="form" class="validate" action="/newadmin/index.php/Admin/Meitu/edit" method="post">
            <div class="form-group">
              <label>文字内容</label>
              <div class="row">
                <div class="col-md-6">
                  <textarea class="form-control"><?php echo ($data["txt"]); ?></textarea>
                </div>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="qy-upload upload-pic qy-upload-1">
                    <ul>
                      <?php if(!empty($data["tutieurl"])): ?><li>
                          <img src="<?php echo ($data["tutieurl"]); ?>">
                          <input type="hidden" name="pic" value="<?php echo ($data["tutieurl"]); ?>">
                          <!--<span class="qy-upload-del"><i class="fa fa-remove"></i></span>-->
                        </li><?php endif; ?>
                      <li class="upload-pic-wrap" <?php if(!empty($data["tutieurl"])): ?>style="display:none;"<?php endif; ?>>
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="qy-upload upload-pic qy-upload-2">
                    <ul>
                      <?php if(!empty($data["photo"])): ?><li>
                          <img src="<?php echo ($data["photo"]); ?>">
                          <input type="hidden" name="pic" value="<?php echo ($data["photo"]); ?>">
                          <!--<span class="qy-upload-del"><i class="fa fa-remove"></i></span>-->
                        </li><?php endif; ?>
                      <li class="upload-pic-wrap" <?php if(!empty($data["photo"])): ?>style="display:none;"<?php endif; ?>>
                      <i class="fa fa-plus"></i>
                      <input type="file" class="upload-pic-button" name="qy_upload">
                      </li>
                    </ul>
            ...
            <div class="form-group">
              ...
              <div class="row">
                <div class="col-md-6">
                  <?php if(($data["shenhe"]) == "2"): ?><input type="text" class="form-control" value="是"><?php else: ?><input type="text" class="form-control" value="否"><?php endif; ?>
                </div>
              </div>
            </div>
