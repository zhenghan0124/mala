 ...
 * @author @janpun
 */
class GwfxController extends CommonController{
  ...
  public function index() {
    ...
    $data = M('Gwfx') -> order('rank desc,time desc,id desc') -> limit($Pages -> firstRow.','.$Pages -> listRows) -> select();
