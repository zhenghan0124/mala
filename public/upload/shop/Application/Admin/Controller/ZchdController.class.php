 ...
 * @author @janpun
 */
class ZchdController extends CommonController{
  ...
  public function index() {
    ...
    $data = M('Zchd') -> order('rank desc,time desc,id desc') -> limit($Pages -> firstRow.','.$Pages -> listRows) -> select();
