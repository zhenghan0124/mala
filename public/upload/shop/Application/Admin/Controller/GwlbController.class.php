 ...
 * @author @janpun
 */
class GwlbController extends CommonController{
  ...
  public function index() {
    ...
    $data = M('Gwlb') -> order('rank desc,time desc,id desc') -> limit($Pages -> firstRow.','.$Pages -> listRows) -> select();
