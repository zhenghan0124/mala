 ...
 * @author @janpun
 */
class GwcxController extends CommonController{
  ...
  public function index() {
    ...
    $data = M('Gwcx') -> order('rank desc,time desc,id desc') -> limit($Pages -> firstRow.','.$Pages -> listRows) -> select();
