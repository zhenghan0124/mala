 ...
 * @author @janpun
 */
class GwjgController extends CommonController{
  ...
  public function index() {
    ...
    $data = M('Gwjg') -> order('rank desc,time desc,id desc') -> limit($Pages -> firstRow.','.$Pages -> listRows) -> select();
