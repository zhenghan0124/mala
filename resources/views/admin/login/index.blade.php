...
<head>
    ...
    <title>欢迎登录后台管理系统--麻辣断句</title>
    <link href="/mala/css/style.css" rel="stylesheet" type="text/css"/>
    <script language="JavaScript" src="/mala/js/jquery.js"></script>
    <script src="/mala/js/cloud.js" type="text/javascript"></script>
...
<body style="background-color:#1c77ac; background-image:url(/mala/images/light.png); background-repeat:no-repeat; background-position:center top; overflow:hidden;">
        ...
        <form action="/admin/login/index" method="post">
            <ul>
                ...
                {{--<li><input name="" type="button" class="loginbtn" value="登录"--}}
                           {{--onclick="javascript:window.location='main.html'"/><label><input name="" type="checkbox"--}}
