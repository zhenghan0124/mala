...
<div class="formbody">
    ...
    <form action="" method="post">
        ...
        @endif
    <ul class="forminfo">
        <li><label>分类标题</label><input name="title" type="text" class="dfinput" value="{{$type->title}}"/>
            {{--<i>标题不能超过30个字符</i>--}}
        </li>
        <li><label>分类位置</label><input name="location" type="text" class="dfinput" value="{{$type->location}}">
            {{--<i>标题不能超过30个字符</i>--}}
        </li>
