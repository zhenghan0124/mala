...
<div class="rightinfo">
    ...
    <div class="tools">
        ...
        <ul class="toolbar">
            <li class=""><span><img src="/mala/images/t04.png" /></span>用户发布的文章</li>
            <a href="/admin/index/content"><li class=""><span></span>待审核</li></a>
            @foreach($type as $v)
                <a href="/admin/index/content?id={{$v->id}}"><li class=""><span></span>{{$v->title}}</li></a>
            @endforeach
    ...
    <table class="imgtable">
        ...
        <tr>
            ...
            <td>{{$v->time}}</td>
            <td><a href="/admin/admin/details?id={{$v->id}}" >查看</a></td>
            <td>
                @if($v->audit==1)
                    已审核
                    {{--|  <a href="javascript:void(0)" onclick="">添加</a>--}}
                @else
                    待审核
